...
const cardObjectDefinitions = [
    {id:1, imagePath:'images/gormek.png'},
    {id:2, imagePath:'images/joe.png'},
    {id:3, imagePath:'images/karvine.png'},
    {id:4, imagePath:'images/grunusone.png'}
]
const aceId = 4
...
function chooseCard(card)
{
    if(canChooseCard())
    {
        ...
        setTimeout(() => {
            flipCards(false)
            updateStatusElement(currentGameStatusElem,"block", primaryColor,"Oia aqui!!!")
...
function outputChoiceFeedBack(hit)
{
    if(hit)
    {
        updateStatusElement(currentGameStatusElem, "block", winColor, "Achou!! :)")
    }
    else
    {
        updateStatusElement(currentGameStatusElem, "block", loseColor, "Grunus enganou você!! :(")
    }
}
...
function checkForIncompleteGame()
{
    ...
    if(serializedGameObj)
    {
        ...
        {
            if(confirm('Você gostaria de continuar do último jogo?'))
            {
                score = gameObj.score
...
function shuffleCards()
{
    ...
    function shuffle()
    {
        ...
        if(shuffleCount == 500)
        {
            ...
            dealCards()
            updateStatusElement(currentGameStatusElem, "block", primaryColor, "Clique onde você acha que o Grunus esta escondido")
